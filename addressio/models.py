...
class Division(BaseModelWithUIDSlug):
...
class District(BaseModelWithUIDSlug):
    name = models.CharField(max_length=255)
    bengali_name = models.CharField(max_length=255, blank=True)
    latitude = models.DecimalField(
        max_digits=20, decimal_places=15, null=True, blank=True
...
class Upazila(BaseModelWithUIDSlug):
    """
    this is also police station
    """

    # Relationship Important Foreignkeys
...
class PostOffice(BaseModelWithUIDSlug):
    # Relationship Important Foreignkeys
